...
//INTERACIION CON EL HTML DEL MAIN TRIANGULO
    ...
    // INGRESAR-LADOS-triangulo
        ...
        function ingresar__ladostriangulo(){
            ...
            if( valueladoA >= 1 && valueladoB >= 1 && valueladoC >=1){
                ...
                alert("porfavor ingresa  primero el tamaño del lado A , el lado B y despues el tamaño de la base del triangulo para continuar..");
                console.log("Error!");
            }
    ...
    //CALCULAR-PERIMETRO-triangulo
        ...
        function ingresar__perimetroTriangulo(){
            const inputLadoA1 = Number(  document.getElementById("input__ladoA--triangulo").value);
            const inputLadoB2 = Number(document.getElementById("input__ladoB--triangulo").value);
            const inputLadoC3 = Number(document.getElementById("input__ladoC--triangulo").value);
    ...
    //CALCULAR-AREA-TRIANGULO
        ...
        function calcular__areaTriangulo(){
            ...
            const inputbase1 = Number(document.getElementById("input__ladoC--triangulo").value);
            const valueAltura = Number(document.getElementById("input__altura--triangulo").value);
            ...
            if( inputbase1 >= 1 && valueAltura >=1){
                ...
                alert("porfavor  ingresa un valor mayor a 0   para que  puedas calcular el area del triangulo..");
                console.log("Error!");
            }
                
            else{
                alert("porfavor ingresa  primero la  base  y despues la altura  para que  puedas calcular el area del triangulo ..");
                console.log("Error!");
            }
...
//INTERACIION CON EL HTML DEL MAIN CIRCULO
    ...
    //CALCULAR DIAMETRO-CIRCULO
        ...
        function calcular__diametroCirculo(){
            const inputRadio = Number(document.getElementById("input__radioCirculo").value);
            ...
            if( inputRadio >= 1 ){
                ...
                alert("porfavor ingresa el radio del circulo para calcular el diametro del circulo  ..");
                console.log("Error!");
            }
        }
    ...
    //CALCULAR EL AREA-CIRCULO
        function calcular__areaCirculo(){
            ...
            if( inputRadio >= 1){
                ...
                alert("porfavor ingresa  primero el radio del cirtculo para que  puedas calcular el area del circulo ..");
                console.log("Error!");
            }
        }